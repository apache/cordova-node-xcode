...
function defaultExtension ({ lastKnownFileType, explicitFileType }) {
    const filetype = lastKnownFileType && lastKnownFileType !== DEFAULT_FILETYPE
...
function defaultEncoding ({ lastKnownFileType, explicitFileType }) {
    const filetype = lastKnownFileType || explicitFileType;
...
function detectGroup ({ basename, lastKnownFileType, explicitFileType }, { customFramework, embed }) {
    const extension = path.extname(basename).substring(1);
    const filetype = lastKnownFileType || explicitFileType;
...
function detectSourcetree ({ lastKnownFileType, explicitFileType, customFramework }) {
    const filetype = lastKnownFileType || explicitFileType;
...
function defaultPath ({ lastKnownFileType, explicitFileType, customFramework }, filePath) {
    const filetype = lastKnownFileType || explicitFileType;
